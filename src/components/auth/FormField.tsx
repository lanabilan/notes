...
const inputBase =
  "w-full min-h-11 rounded-lg bg-background border px-3 py-2 pl-10 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 transition-colors";
